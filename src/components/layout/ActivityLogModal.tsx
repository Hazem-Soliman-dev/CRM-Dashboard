...
const mockActivities = [
  ...
  },
  {
    id: 2,
    type: 'lead_created',
    description: 'Created new lead: Emma Wilson',
    timestamp: '2025-01-15T10:15:00Z',
    details: 'Lead ID: LD-2025-001, Source: Website',
    icon: Plus,
    color: 'text-blue-500'
  },
  {
    ...
    details: 'Customer: TechCorp Solutions, Updated contact details',
    icon: Edit,
  ...
  },
  {
    id: 4,
    type: 'case_viewed',
    description: 'Viewed sales case SC-2025-002',
    timestamp: '2025-01-15T12:45:00Z',
    details: 'Case: Cairo Tours Ltd, Status: In Progress',
    icon: Eye,
  ...
  },
  {
    ...
    details: 'Report type: Sales Performance, Period: December 2024',
    icon: FileText,
  ...
  },
  {
    ...
    details: 'Lead: Robert Davis, Previous status: Contacted',
    icon: Edit,
    color: 'text-green-500'
  },
  {
    ...
    description: 'Added new customer: Global Travel Co',
    timestamp: '2025-01-14T13:15:00Z',
    details: 'Customer type: Corporate, Assigned to: David Wilson',
    icon: Plus,
    color: 'text-blue-500'
  },
  {
